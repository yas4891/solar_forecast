...
export const en: Dictionary = {
  ...
  forecastProviderAuto: "Automatic",
  ...
  warningSources: "Forecast sources cannot be discovered.",
  warningForecast: "A forecast is unavailable.",
  ...
  warningProviderInvalid: "The selected forecast provider is invalid.",
  warningProviderUnavailable: "The selected forecast provider is not configured.",
  warningSolcastAmbiguous: "More than one enabled Solcast configuration was found.",
  warningSolcastMode: "The Solcast forecast mode is unavailable or invalid.",
};
